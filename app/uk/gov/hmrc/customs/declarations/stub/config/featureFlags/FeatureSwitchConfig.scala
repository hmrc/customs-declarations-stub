...
import uk.gov.hmrc.customs.declarations.stub.features.{Feature, FeatureStatus}
import uk.gov.hmrc.customs.declarations.stub.features.Feature.Feature
import uk.gov.hmrc.customs.declarations.stub.features.FeatureStatus.FeatureStatus
...
class FeatureSwitchConfig @Inject() (configuration: Configuration) {
  ...
  private def loadConfig(key: String): String =
    configuration
      ...
      .getOrElse(throw new IllegalStateException(s"Missing configuration key: $key"))
